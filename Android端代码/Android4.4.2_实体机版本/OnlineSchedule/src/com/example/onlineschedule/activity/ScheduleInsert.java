...
public class ScheduleInsert extends Activity implements android.view.View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ArrayAdapter<String>adapter2=new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, NO);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.schedule_insert_bt1) {
            ...
            /*try{
				...
				String sql="Update todo_schedule set todo_course = '"+cname+"', todo_add='"+address+"'" +
				"where todo_week='"+week+"' and todo_section='"+no+"'";
				db.execSQL(sql);
				Toast.makeText(ScheduleInsert.this, "更新数据成功！", Toast.LENGTH_SHORT).show();
		      }catch (Exception e) {

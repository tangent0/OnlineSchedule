...
<table class="add_table" width="100%">
    ...
    <tr>
        <td >            
            <asp:Label ID="Label1" runat="server" Text="第一二节(8:00-10:00)"></asp:Label>  
        ...
        <td style="width:300px">
            <asp:TextBox ID="tbTeachingWeek1" runat="server" Height="50px" TextMode="MultiLine" Width="90%" />
        </td>
    </tr>
    <tr>
        <td >            
            <asp:Label ID="Label2" runat="server" Text="第三四节(10:00-11:40)"></asp:Label> 
        ...
        <td>
            <asp:TextBox ID="tbTeachingWeek2" runat="server" Height="50px" TextMode="MultiLine" Width="90%" />
        </td>
    </tr>
    <tr>
        <td >            
            <asp:Label ID="Label3" runat="server" Text="第四五节(13:30-15:10)"></asp:Label> 
        ...
        <td>
            <asp:TextBox ID="tbTeachingWeek3" runat="server" Height="50px" TextMode="MultiLine" Width="90%" />
        </td>
    </tr>
    <tr>
        <td >            
            <asp:Label ID="Label4" runat="server" Text="第五六节(15:30-17:10)"></asp:Label> 
        ...
        <td>
            <asp:TextBox ID="tbTeachingWeek4" runat="server" Height="50px" TextMode="MultiLine" Width="90%" />
        </td>
    </tr>
